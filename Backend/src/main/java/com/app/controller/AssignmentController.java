...
//    }
    ...
    public ResponseEntity<List<Assignment>> getAssignmentsByDepartment(@PathVariable Long departmentId) {
        System.out.println("Department id"+departmentId);
    	List<Assignment> assignments = assignmentService.getAssignmentsByDepartment(departmentId);
